...
body = re.search(r'<div class="article-body accounting-guide staffing-model-guide">(.*)</div>', article, re.S)
...
checks = {
    ...
    'h1_keyword_prefix': h1_text.lower().startswith('staff outsourcing philippines'),
    ...
    'unique_marker': 'data-article-marker="ph-staffing-model-2026"' in article,
    ...
    'dated_statistics': all(value in text for value in ['52,204,133', '2025 unemployment at 2.235%', '59.979%', '44,699,749', '2021']),
