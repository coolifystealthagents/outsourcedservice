...
MARKER = 'ph-knowledge-base-20260728'
...
body = re.search(r'<div class="article-body accounting-guide knowledge-base-guide">(.*)</div>', article, re.S)
if not body:
    raise SystemExit('AUDIT_SELECTOR_MISMATCH: knowledge base article body')
paragraphs = []
...
checks = {
    ...
    'h1_keyword_prefix': h1_text.lower().startswith('philippines knowledge base maintenance'),
    ...
    'chart_present': 'class="evidence-chart"' in article and 'knowledge-chart-title' in article,
    'graphic_present': 'class="review-graphic"' in article and 'knowledge-graphic-title' in article,
