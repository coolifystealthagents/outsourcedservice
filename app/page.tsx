    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          ...
          <h1>Outsourced Service: a service catalog for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced service guide for buyers comparing outsourced service options for back office and customer work. The page now uses a distinct minimal monochrome layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>monochrome catalog lines</figcaption></figure>
      </div>
    </section>
